...
<body id="page-top">
    ...
    <!-- Remarks -->
                                                ...
                                                <div class="card-body text-left" style="height: 107px;"><form:textarea id="remarks"  path="remarks" class="form-control-lg" style="height: 108px;width: 220px;"></form:textarea></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
