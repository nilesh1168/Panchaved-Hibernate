    ...
    <!-- Secondary Details                                         -->
                                            <div class="card-body">
                                              <!--  <form id="f2"> -->
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <div class="form-group"><label for="first_name"><strong> Name</strong></label><form:input path="doctorName" value="${doctor.doctorName}" class="form-control" type="text" placeholder="Doctor's Name" style="margin: -7px;"/></div>
                                                        </div>
                                                        <div class="col">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"><label for="qualification">&nbsp;<strong>Qualification</strong></label><form:input path="doctorQualification" value="${doctor.doctorQualification}" class="form-control" type="text" placeholder="Qualification/designation"  style="margin: -7px;"/></div>
                                                        </div>
                                                        <div class="col">
