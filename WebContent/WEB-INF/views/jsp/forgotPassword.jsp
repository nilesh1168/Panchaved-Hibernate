                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                    	...
                                    	<button id="securityQuestion" class="btn btn-primary btn-block text-white btn-user" type="button">Get Security Question</button>
                                    	</div>
                                    	<font color="green"><label id="question"></label></font>
