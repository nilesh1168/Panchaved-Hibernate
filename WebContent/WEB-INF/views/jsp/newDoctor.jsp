...
<body id="page-top">
                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <form class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            ...
                            <h5 class="text-dark mb-0">${success_msg}</h5>
                        </form>
    ...
    <!-- Basic Details -->
                                    <div class="card-body" style="margin: 0px;">
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label ><strong>Doctor Id</strong><br></label><form:input id = "docID" path="doctorID" class="form-control" type="text" inputmode="numeric" minlength="10" maxlength="10" required="" autofocus="" placeholder="10 digits"/></div>
                                                </div>
                                                <div class="col">
    ...
    <!-- Secondary Details                                         -->
                                            <div class="card-body">
                                              <!--  <form id="f2"> -->
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <div class="form-group"><label for="first_name"><strong> Name</strong></label><form:input id = "docName" path="doctorName" class="form-control" type="text" placeholder="Doctor's Name" style="margin: -7px;"/></div>
                                                        </div>
                                                        <div class="col">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"><label for="qualification">&nbsp;<strong>Qualification</strong></label><form:input id = "docQual" path="doctorQualification" class="form-control" type="text" placeholder="Qualification/designation"  style="margin: -7px;"/></div>
                                                        </div>
                                                        <div class="col">
